...
class FormateurController extends Controller
{
    ...
    public function index()
    {
        ...
        })->with(['role', 'themes.formation.sessions', 'themes.participants.user', 'themes.sessions'])->get();
    ...
    public function show(User $formateur)
    {
        ...
        return new UserResource($formateur->load(['role', 'themes.formation.sessions', 'themes.participants.user', 'themes.sessions']));
    }
